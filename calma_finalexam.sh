...
mysqladmin -u root -p$passwd version
...
mysql -u root -p$passwd << SQL
CREATE DATABASE ${dbname};
CREATE USER ${uname}@localhost IDENTIFIED BY '${passwd}';
GRANT ALL PRIVILEGES ON wordpress.* TO ${uname}@localhost IDENTIFIED BY '${passwd}';
FLUSH PRIVILEGES;
SQL
...
sed -i 's/password_here/${passwd}/' /var/www/html/wp-config.php
...
echo -e "\n======================================================================================================================================="
echo "	Please visit http://your_server_IP_address/ or server's domain name in your browser to complete your Wordpress site setup."
echo -e "=======================================================================================================================================\n"
